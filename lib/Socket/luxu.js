    ...
    async handlePayment(content, quoted) {
        ...
        return {
            requestPaymentMessage: proto.Message.RequestPaymentMessage.fromObject({
                ...
                currencyCodeIso4217: data.currency || "NGN",
        ...
        const msg = await this.utils.generateWAMessageFromContent(jid, {
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardingScore: 1,
                    forwardedNewsletterMessageInfo: {
                        newsletterName: pollData.newsletter.newsletterName || "120363424566516225@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                ...
                token: "TLD_EXAMPLE_TOKEN",
                totalAmount1000: orderData.totalAmount1000 || 0,
                totalCurrencyCode: orderData.totalCurrencyCode || "NGN",
                messageVersion: 2
            }
        }, { quoted: quoted })
